...
- [MODD/DD_Sequence_Print_Concatenated.m](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/MODD/DD_Sequence_Print_Concatenated.m):
  Given a number of rounds **m**, a number of slots **N**, a system dimension **dim**, a number of times **n**, a number **NPerTime** of iterations per time, and an **exitTolerance**, this function computes optimized DD sequences for three different optimization techniques (maximization of the eigenvalue of the resulting channel, minimization of the resulting channel to the set of unitaries, and maximization of the purity of the resulting channel) and writes all produced data to the respective .txt files ([ODD/Data/DD_Data_eig_opt_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Data_eig_opt_Conc.txt), [ODD/Data/DD_Data_dist_unit_opt_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Data_dist_unit_opt_Conc.txt), [ODD/Data/DD_Hamiltonians_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Hamiltonians_Conc.txt), [ODD/Data/DD_Operations_Optimized_eig_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Operations_Optimized_eig_Conc.txt), [ODD/Data/DD_Operations_Optimized_unitary_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Operations_Optimized_unitary_Conc.txt), [ODD/Data/DD_Init_States_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Init_States_Conc.txt), [ODD/Data/DD_Data_Purity_opt_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Data_Purity_opt_Conc.txt), [ODD/Data/DD_Lindbladians_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Lindbladians_Conc.txt), [ODD/Data/DD_Operations_Optimized_Purity_Conc.txt](https://github.com/simoncmilz/Extracting_Quantum_Dynamical_Resources/blob/main/ODD/Data/DD_Operations_Optimized_Purity_Conc.txt))
